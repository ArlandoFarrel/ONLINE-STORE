                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" name="telp" type="number" placeholder="Enter your Phone number"  />
                                                        <label for="inputFirstName">Phone Number</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" name="password" type="Password" placeholder="Enter your Username" />
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><input type="submit" name="simpan" value="Create an Account" class="btn btn-primary"></div>
                                            </div>
                                        </form>
                                    </div>
