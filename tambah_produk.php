...
<body>
    ...
    <form action="proses_tambah_produk.php" method="post" enctype="multipart/form-data">
        ...
        Deskripsi : 
        <textarea id="" name="deskripsi" class="form-control" rows="3" cols="50"></textarea>
        Harga :
        <input type="number" name="harga" value="" class="form-control">
        Foto Produk :
        <input type="file" name="foto" accept=".jpg, .jpeg, .png" value="" class="form-control">
        
        <input type="submit" name="simpan" value="Tambah Produk" class="btn btn-primary">
    </form>
    <a href="tampil_produk.php">Data</a>
