...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">ULTRASO</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="tampil_petugas.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-address-book"></i></i></i></div>
                                Admin
                            </a>
                            ...
                            <a class="nav-link" href="historipetugas.php">
            ...
            while ($data_petugas = mysqli_fetch_array($qry_petugas)) {
                ...
                <tr>
                    ...
                    <td><a href="ubah_petugas.php?id_petugas=<?= $data_petugas['id_petugas'] ?>" class="btn btn-success">Ubah</a> 
                        <a href="hapuspetugas.php?id_petugas=<?= $data_petugas['id_petugas'] ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a>
                    </td>
