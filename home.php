...
<body>
  ...
  <div class="site-wrap">
            ...
            <div class="col-6 col-md-4 order-3 order-md-3 text-right">
              <div class="site-top-icons">
                <ul>
                  ...
                  <li>
                    <a href="keranjang.php" class="site-cart">
    ...
    <div class="site-blocks-cover" style="background-image: url(home/images/hero_1.jpg);">
      <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            <h1 class="mb-2"> Welcome <?= $_SESSION['nama'] ?> To Our Shop</h1>
                ...
                <div class="item">
                  <div class="block-4 text-center">
                    <figure class="block-4-image">
                      <img src="assets/foto_produk/<?= $dt_buku['foto'] ?>" height="1000px" alt="Image placeholder" class="img-fluid">
                    </figure>
                    <div class="block-4-text p-4">
                      <h3><a href="#"><?= $dt_buku['nama_produk'] ?></a></h3>
                      <p class="mb-0"><?= $dt_buku['deskripsi'] ?></p>
                      <p class="text-primary font-weight-bold">Rp. <?= $dt_buku['harga'] ?></p>
                      <a href="beli.php?id_produk=<?= $dt_buku['id_produk'] ?>" class="btn btn-sm btn-primary">Add to Cart</a>
                    </div>
                  </div>
                </div>
              </div>
