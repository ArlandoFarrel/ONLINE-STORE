...
<?php 
        ...
        if($hasil && $hasil2 ){
        include "koneksi.php";
            echo "<script>alert('Sukses hapus histori');location.href='historipetugas.php';</script>";
        } else {
            echo "<script>alert('Gagal hapus histori');location.href='historipetugas.php';</script>";
        }
    }
?>