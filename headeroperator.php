      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="tampil_pelanggan.php">Pelanggan</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="tampil_petugas.php">Petugas</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="historipetugas.php">Histori Pembelian</a>
            </li>
            <li class="nav-item">
